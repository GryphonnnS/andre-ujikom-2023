            ...
            <div class="white-box">
                ...
                <div class="row">
                    <div class="col-md-12 text-center">
                        ...
                        <a href="transaksi.php" class="btn btn-warning"><i class="fa fa-arrow-left fa-fw"></i> Kembali Ke Menu Utama</a>
                        <a href="cetakk.php?id=<?= $_GET['id'];?>" class="btn btn-warning"><i class="fa fa-arrow-left fa-fw"></i>cetak</a>
                    </div>
                </div>
